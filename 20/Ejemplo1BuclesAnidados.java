...
public class Ejemplo1BuclesAnidados {
    public static void main(String[] args) {
        ...
        //es un codigo anidado que tiene las instruccion do, while y for
        do{
        ...
        //cuando introduscas un num de filas y colummnas se va a ejecutar la instruccion siguiente y va a colocar "*"en un cuadro con su limite de columnas y filas
